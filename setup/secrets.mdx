...
You can also store secrets in Azure Key Vault. To enable this, create an `AZURE_CREDENTIALS` secret in GitHub. See [Azure_Credentials](#azure-credentials) for details.
